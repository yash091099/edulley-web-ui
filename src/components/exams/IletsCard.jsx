  ...
  return (
    <div className="course_card mt-0" style={{ backgroundColor: "rgb(243 243 243 / 47%)" }}>
      ...
      <div className="mt-4">
        ...
        <p className=" mb-5" style={{fontFamily: 'Gilroy-Medium'}}>
        ...
        <div className="table-container mt-[150px]">
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Medium'}}>Listening</td>
                            <td data-label="Number of Questions and Duration"  style={{fontFamily: 'Gilroy-Medium'}}>
                              Four recordings, 40 questions, 30 minutes + 10
                              minutes (transfer time)
                            </td>
                            <td data-label="Content"  style={{fontFamily: 'Gilroy-Medium'}}>
                              Four recorded monologues and conversations.
                            </td>
                            <td data-label="Remarks"  style={{fontFamily: 'Gilroy-Medium'}}>
                          ...
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Medium'}}>Reading</td>
                            <td data-label="Number of Questions and Duration"  style={{fontFamily: 'Gilroy-Medium'}}>
                              40 questions <br />
                              60 minutes
                            </td>
                          ...
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Medium'}}>Writing</td>
                            <td data-label="Number of Questions and Duration" style={{fontFamily: 'Gilroy-Medium'}}>
                              60 minutes
                            </td>
                            <td data-label="Content"  style={{fontFamily: 'Gilroy-Medium'}}>
                          ...
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Medium'}}>Speaking </td>
                            <td data-label="Number of Questions and Duration" style={{fontFamily: 'Gilroy-Medium'}}>
                              11 to 14 minutes{" "}
                            </td>
                            <td data-label="Content"  style={{fontFamily: 'Gilroy-Medium'}}>
      ...
      <div className="mt-4">
        ...
        <p style={{fontFamily: 'Gilroy-Medium'}}>You should take a practice test because that is the best way to identify your weaknesses. It is crucial for students to understand what to expect from the test format before they start practicing. Reviewing each section's test content, questions, and task types can help students become more familiar with it. The last piece of advice is to start exam preparation at least three to six months in advance.</p>
