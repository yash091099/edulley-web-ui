...
const IletsCard = () => {
  return (
    <div className="course_card mt-0" style={{ backgroundColor: "rgb(243 243 243 / 47%)" }}>
      <div>
        <h4 style={{fontFamily: 'Gilroy-Bold'}}>Overview</h4>
      ...
      <div className="mt-4">
        <h4   style={{fontFamily: 'Gilroy-Bold'}}>IELTS Syllabus</h4>
        <p className=" mb-5" style={{fontFamily: 'Gilroy-Regular'}}>
        ...
        <div className="table-container mt-[150px]">
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Regular'}}>Listening</td>
                            <td data-label="Number of Questions and Duration"  style={{fontFamily: 'Gilroy-Regular'}}>
                              Four recordings, 40 questions, 30 minutes + 10
                              minutes (transfer time)
                            </td>
                            <td data-label="Content"  style={{fontFamily: 'Gilroy-Regular'}}>
                              Four recorded monologues and conversations.
                            </td>
                            <td data-label="Remarks"  style={{fontFamily: 'Gilroy-Regular'}}>
                          ...
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Regular'}}>Reading</td>
                            <td data-label="Number of Questions and Duration"  style={{fontFamily: 'Gilroy-Regular'}}>
                              40 questions <br />
                              60 minutes
                            </td>
                          ...
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Regular'}}>Writing</td>
                            <td data-label="Number of Questions and Duration" style={{fontFamily: 'Gilroy-Regular'}}>
                              60 minutes
                            </td>
                            <td data-label="Content"  style={{fontFamily: 'Gilroy-Regular'}}>
                          ...
                          <tr>
                            <td data-label="Section"  style={{fontFamily: 'Gilroy-Regular'}}>Speaking </td>
                            <td data-label="Number of Questions and Duration" style={{fontFamily: 'Gilroy-Regular'}}>
                              11 to 14 minutes{" "}
                            </td>
                            <td data-label="Content"  style={{fontFamily: 'Gilroy-Regular'}}>
      ...
      <div className="mt-4">
        <h4  style={{fontFamily: 'Gilroy-Bold'}}>IELTS Preparation</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>You should take a practice test because that is the best way to identify your weaknesses. It is crucial for students to understand what to expect from the test format before they start practicing. Reviewing each section's test content, questions, and task types can help students become more familiar with it. The last piece of advice is to start exam preparation at least three to six months in advance.</p>
        <h4 style={{fontFamily: 'Gilroy-Bold'}} className="mt-3">Test Format</h4>
      ...
      <div className="mt-4">
        <h4  style={{fontFamily: 'Gilroy-Bold'}}>Language Skills</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>
      ...
      <div className="mt-4">
        <h4  style={{fontFamily: 'Gilroy-Bold'}} >Develop Time Management Skills</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>
      ...
      <div className="mt-4">
        <h4  style={{fontFamily: 'Gilroy-Bold'}}>Focus on Weak Areas</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>
      ...
      <div className="mt-4">
        <h4  style={{fontFamily: 'Gilroy-Bold'}}>Use English in Daily Life</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>
      ...
      <div className="mt-4" >
        <h4  style={{fontFamily: 'Gilroy-Bold'}}>Seek Feedback</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>
      ...
      <div className="mt-4">
        <h4  style={{fontFamily: 'Gilroy-Bold'}}>Stay Motivated</h4>
        <p style={{fontFamily: 'Gilroy-Regular'}}>
