...
const StudentSays = () => {
  ...
  <button
    style={{ width: "36px", height: "36px", position: "absolute", top: "50%",right:"18rem", transform: "translateY(-50%)" }}
    variant="primary"
  ...
  />
  <button
    style={{ width: "36px", height: "36px", position: "absolute", top: "50%",left:"18rem", transform: "translateY(-50%)" }}
    variant="primary"
